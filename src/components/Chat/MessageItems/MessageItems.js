...
const MessageItems = ({ type, avatar, name, time, message, image, id, onEditMessage }) => {
    ...
    return (
        <div className={cn('message-items', { 'my-message': type === 'my', 'your-message': type === 'your' })}>
            ...
            <div className="message-items__content">
                ...
                {isEditing ? (
                    <div className="message-items__edit">
                        ...
                        />
                        <button className="message-items__btn save" onClick={handleSaveClick}>💾</button>
                        <button className="message-items__btn cancel" onClick={handleCancelClick}>❌</button>
                    </div>
                ) : (
            ...
            {!isEditing && type === 'my' && (
                <button className="message-items__edit-btn" onClick={handleEditClick}>✏️</button>
            )}
        </div>
    );
};
